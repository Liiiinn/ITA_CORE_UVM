...
class ita_mha8_protocol_random_vsequence extends ita_mha8_vsequence;
    ...
    function void load_protocol_random_plusargs();
        ...
        begin
            int unsigned config_toggle_value;
            config_toggle_value = config_toggle_mode;
            if ($value$plusargs("ITA_PROTOCOL_CONFIG_TOGGLE=%d", config_toggle_value))
                config_toggle_mode = (config_toggle_value != 0);
        end
